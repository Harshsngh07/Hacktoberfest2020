/*
* This is a C program that showcase an excercise in pixel manipulation of a BMP file. 
* It will produce a red, blue, green, black and white and blurred copy of the image.
* Define the filename and path using the preprocessor command and run it to produce the images.
* Several test and sample images are included.
*/
...
#define FILENAME "Test_Image/image.bmp"
